 ...
 * 首页图片轮播适配器
 */
public class HomeAdAdapter implements Holder<AdListBean.AdBean> {
    ...
    @Override
    public void UpdateUI(final Context context, final int position, final AdListBean.AdBean data) {
        if (data == null){
            return;
        }
